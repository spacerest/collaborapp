"""
Django settings for collaborapp project.
...
ALLOWED_HOSTS = ['thisisatest.life', 'www.thisisatest.life', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'collaborapp.wsgi.application'
