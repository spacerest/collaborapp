...
class ImageMessage(models.Model):
    ...
    envelope = models.ForeignKey(Envelope, related_name='image_messages', on_delete=models.CASCADE, null=True, blank=True)
    date_created = models.DateTimeField(auto_now_add=True)
    def __str__(self):
...
class PdfMessage(models.Model):
    ...
    envelope = models.ForeignKey(Envelope, related_name='pdf_messages', on_delete=models.CASCADE, null=True, blank=True)
    date_created = models.DateTimeField(auto_now_add=True)
    def __str__(self):
        return self.date_created.ctime()

#TODO cleanup pdf and image files on delete
